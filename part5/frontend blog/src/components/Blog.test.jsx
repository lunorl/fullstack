...
test('blog display title and author but not likes', async () => {
    ...
    render(<UserProvider><BlogProvider><Blog bloge={bloge} index={1}/></BlogProvider></UserProvider>)
...
test('blog likes', async () => {
    ...
    render(
        <UserProvider><BlogProvider initialBlogs={initialBlogs}>
            <Blog bloge={blog} click={click} index={0} />
        </BlogProvider></UserProvider>
    )
...
test('new blog works', async () => {
    ...
    render(
        <MaybeProvider><WordsProvider><UserProvider><BlogProvider>
            <CreateForm blogService={blogService} test={true}/>
        </BlogProvider></UserProvider></WordsProvider></MaybeProvider>
    );
